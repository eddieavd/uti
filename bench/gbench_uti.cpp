...
BENCHMARK( bm_push_back_trivial< std::vector< int > > )->RangeMultiplier( 2 )->Range( 1024, 1024 << 8 )->Unit( benchmark::kMicrosecond );
BENCHMARK( bm_push_back_trivial< uti::vector< int > > )->RangeMultiplier( 2 )->Range( 1024, 1024 << 8 )->Unit( benchmark::kMicrosecond );
...
BENCHMARK( bm_push_back_reserved_trivial< std::vector< int > > )->RangeMultiplier( 2 )->Range( 1024, 1024 << 8 )->Unit( benchmark::kMicrosecond );
BENCHMARK( bm_push_back_reserved_trivial< uti::vector< int > > )->RangeMultiplier( 2 )->Range( 1024, 1024 << 8 )->Unit( benchmark::kMicrosecond );
